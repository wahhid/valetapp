...
/*
 * DailyReportFormFrame.java
 *
 * Created on Aug 12, 2011, 9:39:31 AM
 */
 ...
 * @author wahhid
 */
public class DetailPerOperatorReportFrame extends InternalFrame {

    private DetailPerOperatorReportController controller;
    /** Creates new form DailyReportFormFrame */
    public DetailPerOperatorReportFrame(DetailPerOperatorReportController controller) {
        initComponents();
        this.controller = controller;
        this.cbBooth.setDomain(this.controller.getDomainController().getCBBooth());
        this.cbOperator.setDomain(this.controller.getDomainController().getCBEmployee());
    ...
    private void initComponents() {
        ...
        setTitle("Report Detail By Operator");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        System.out.println("Date : " + dcDate.getDate());
        System.out.println("Booth : " + cbBooth.getValue().toString());
        System.out.println("Operator : " + cbOperator.getValue().toString());
        List<Transvalet> transvalets = this.getTransvaletController().getData(this.dcDate.getDate(), this.cbBooth.getValue().toString(), this.cbOperator.getValue().toString());
        
        JRDataSource dataSource = new JRBeanCollectionDataSource(transvalets);                
        
        new ReportViewerController(this.controller.getFilePath(),parameters,dataSource,"Test");        
