...
@NamedQueries({
    ...
    @NamedQuery(name = "Pricing.findByCreatedby", query = "SELECT p FROM Pricing p WHERE p.createdby = :createdby"),
    @NamedQuery(name = "Pricing.findByUpdateddate", query = "SELECT p FROM Pricing p WHERE p.updateddate = :updateddate"),
    @NamedQuery(name = "Pricing.findByUpdatedby", query = "SELECT p FROM Pricing p WHERE p.updatedby = :updatedby")})
public class Pricing extends ValueObjectImpl implements Serializable {
    ...
    public Pricing(Integer pricingid, String pricingname, long pricinghourly, long pricingservices, boolean pricingenable, boolean pricingservicesenable, boolean limittimeenable, double limittimecharge, Date limitime, boolean nextday, Date createddate, String createdby, Date updateddate, String updatedby) {
        this.pricingid = pricingid;
    ...
    public String toString() {
        return "org.jakc.valetadmindesk.entity.Pricing[ pricingid=" + pricingid + " ]";
    }
