...
@NamedQueries({
    ...
    @NamedQuery(name = "Voucher.findByVouchernumbers", query = "SELECT v FROM Voucher v WHERE v.vouchernumbers = :vouchernumbers"),
    ...
    @NamedQuery(name = "Voucher.findByGenerated", query = "SELECT v FROM Voucher v WHERE v.generated = :generated"),
...
public class Voucher extends ValueObjectImpl implements Serializable {
    ...
    public Voucher(Integer voucherid, String voucherdesc, String voucherpref, int voucherdigit, Date voucherstartdate, Date voucherenddate, int vouchernumbers, double vouchervalue, boolean status, boolean generated, Date createddate, String createdby) {
        this.voucherid = voucherid;
    ...
    public void setVouchernumbers(int vouchernumbers) {
        this.vouchernumbers = vouchernumbers;
    }
    ...
    public String toString() {
        return "org.jakc.valetadmindesk.entity.Voucher[ voucherid=" + voucherid + " ]";
    }
