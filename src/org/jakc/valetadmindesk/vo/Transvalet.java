...
@NamedQueries({
    ...
    @NamedQuery(name = "Transvalet.findByCorrection", query = "SELECT t FROM Transvalet t WHERE t.correction = :correction"),
...
public class Transvalet extends ValueObjectImpl implements Serializable {
    ...
    public String toString() {
        return "org.jakc.valetadmindesk.vo.Transvalet[ transid=" + transid + " ]";
    }
